...
int main(int argc, char *argv[])
{
    ...
    {
        printf("Usage: udp_test dst_ip dst_port [-d]\n");
        printf("     : udp_test dst_ip dst_port src_port [-d]\n");
        printf("\n");
        return 0;
    }
    ...
    addr_to.sin_port        = htons( dst_port );
    addr_to.sin_addr.s_addr = inet_addr( dst_ip );
    ...
    while ( 1 )
    {
        ...
        retval = select(fd_udp+1, &flags, NULL, NULL, NULL);
